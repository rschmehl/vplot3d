...
init_view(width=600, height=400,
          xmin=0, xmax=1, ymin=0.0, ymax=1.0, zmin=-0.5, zmax=0.5,
          zoom=2, elev=90, azim=270)
...
a1 = Polygon.rotated(PO, file=dat_path / 'clark_y_airfoil.dat',
...
voff = np.array([0, 0.4, 0])
a2 = Polygon.rotated(PO, file=dat_path / 'kite_V3_airfoil.dat',
                     e1=Px, e2=Py, voff=voff, edgecolor='k', facecolor='k',
                     scale=1, linewidth=2, alpha=0.1, edgecoloralpha=0.8)
ax.annotate3D('TU Delft V3 kite  center airfoil', xyz=0.25*Px+0.35*Py)

voff = np.array([0.5, 0.8, 0])
a3_1 = Polygon.rotated(PO, file=dat_path / 'kite_V3_tubeframe.dat',
                       e2=Py, e3=Pz, voff=voff, edgecolor='k', facecolor='k',
                       scale=1e-4, zorder=10, linewidth=10, alpha=0, edgecoloralpha=1)
a3_2 = Polygon.rotated(PO, file=dat_path / 'kite_V3_planform.dat',
