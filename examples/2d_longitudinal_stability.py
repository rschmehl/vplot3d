...
def render_vplot3d_diagram(output_path, chord=2.6, ld=8, x_cp=0.32, AR=4.0, angle_depower=0):
    ...
    F_low, v_a_low, F_high, v_a_high = rotate_all(angle_to_y, F_low, v_a_low, F_high, v_a_high)
...
render_vplot3d_diagram('../figures/2d_symmetric_stability', angle_depower=-10, x_cp=0.32, ld = 4)
